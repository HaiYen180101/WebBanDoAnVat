    ...
    <div class="container">
      <div class="row py-2">
        <div class="col-md-8">
          ...
          <form method='post' action="../controllers//upload_category.php" enctype='multipart/form-data'>
            <input type="hidden" name="id">
            <div class="form-group">
              <label for="category_name">Tên danh mục</label>
              <input id="category_name" type="text" name="category_name" class="form-control" maxlength="50" required/>
            </div>
