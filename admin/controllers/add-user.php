            ...
            <form action="" method="POST">
                <table class="tbl-30">
                    <tr>
                        <td>Họ: </td>
                        <td>
                            <input type="text" name="fisrt_name" placeholder="Nhập họ của bạn" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Tên: </td>
                        <td>
                            <input type="text" name="last_name" placeholder="Nhập tên của bạn" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Tên đăng nhập: </td>
                        <td>
                            <input type="text" name="username" placeholder="Nhập đăng nhập của bạn" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Địa chỉ: </td>
                    ...
                    <tr>
                        <td>Số điện thoại: </td>
                        <td>
                            <input type="number" name="phone" placeholder="Điện thoại của bạn" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Ngày đăng kí: </td>
                        <td>
                            <input type="date" name="registration_date" placeholder="" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Mật khẩu: </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="submit" name="submit" value="Add Người dùng" class="btn btn-block btn-primary" required>
                        </td>
                    </tr>
